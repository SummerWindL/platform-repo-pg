...
public interface RoleGroupFunctionRepository extends CommonCustomRepository<BasePlpgsqlModel, Integer> {
     ...
     * @return
     */
    @Query(value= "select * from aix.f_mb_role_group_function_query(?1)", nativeQuery = true)
     ...
     * @return
     */
    @Query(value= "select * from aix.f_mb_role_group_function_save(?1, ?2)", nativeQuery = true)
     ...
     * @return
     */
    @Query(value= "select * from aix.f_mb_role_group_function_delete(?1)", nativeQuery = true)
