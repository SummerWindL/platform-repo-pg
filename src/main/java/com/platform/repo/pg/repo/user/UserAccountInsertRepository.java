...
public interface UserAccountInsertRepository extends CommonCustomRepository<BasePlpgsqlModel, Integer> {

	@Query(value= "select * from aimb.f_mb_user_account_insert(" +
		":in_userid, " + 
		":in_acc, " + 
		":in_pwd, " + 
		":in_salt, " + 
		...
		":in_params" +
	")", nativeQuery = true)
	BasePlpgsqlModel fMbUserAccountInsert(
