...
public interface PrjTitleInsertRepository extends CommonCustomRepository<BasePlpgsqlModel, Integer> {

	@Query(value= "select * from aimb.f_mb_prj_title_insert(" +
		":in_projectid, " + 
		":in_titleid, " + 
		":in_titlename, " + 
		":in_titlelogo" +
	")", nativeQuery = true)
	BasePlpgsqlModel fMbPrjTitleInsert(
